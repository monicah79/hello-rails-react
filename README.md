...
- [📖 ROR Renters app ](#-hello-rails-react)
...
- This is a application built on Ruby on Rails for the backend. and react and redux for front end.Its has api and points and the best part of the application is that you can view the react routes through the static page
...
- git clone `https://github.com/monicah79/hello-rails-react.git`
...
Feel free to check the [issues page](https://github.com/monicah79/hello-rails-react/issues).
